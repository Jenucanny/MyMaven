...
public void handlingFrames()
{
	...
	WebElement framesearch=driver.findElement(By.id("frame1"));
	driver.switchTo().frame(framesearch);
	WebElement frame1=driver.findElement(By.id("sampleHeading"));
	String expectedTxt=frame1.getText();
	String actualText="This is a sample page";
	Assert.assertEquals(actualText,expectedTxt,"Mismatch");
